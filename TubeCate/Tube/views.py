...
import render, get_object_or_404, redirect, reverse
from django.views.generic
import View, DeleteView, ListView
from.forms
import *
from django.http
...
import SearchVector# Create your views here.
...
if (tab == 'clans'):
  return render(request, self.template_name, {
    're_user': re_user,
    'clans': re_user.clan_set.all(),
    'clan_view': True
  })
elif(tab == 'liked'):
  return render(request, self.template_name, {
    're_user': re_user,
    'clans': re_user.likes_set.all(),
    'like_view': True
  })
elif(tab == 'followers'):
  return render(request, self.template_name, {
  ...
  return render(request, self.template_name, {
    're_user': re_user,
    'following': re_user.followers_set.all(),
    'following_view': True
  })
